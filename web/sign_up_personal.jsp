<%-- 
    ...
    Created on : Dec 7, 2016, 8:02:04 PM
    Author     : KD
--%>
...
<html lang="en">
    ...
    <body>
        <div class="login_page_body">
            ...
            <div class="panel-heading"><img class="logo" src="img/logo.png"><br><br>
                    <h2 >Sign Up</h2></div>
                <form action="sign_up_personal_controller.jsp" method="POST" class="panel-body">
                    <input class="form-control" placeholder="username" type="text" name="userName" required/><br>
                    
                    <a href="javascript:NewCal('demo1','ddmmyyyy',false,24)"><input class="form-control" placeholder="date of birth" id = "demo1" type="text" name="dateOfBirth"></a>
	...
	<option value="NA" title="Select Country">Afghanistan</option>
...
<input type="text" name="sate" value="1" hidden/><br>
